...
// This basically checks that the webhook event is coming from clerk,
// then listens to see if the event creates a user.
// If so, the user is saved to the database (convex)
